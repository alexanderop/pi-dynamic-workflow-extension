...
**Concurrency corollary:** Before sharing state between actors, ask "What happens if another actor modifies this concurrently?" If not "nothing", isolate or apply [[principles/serialize-shared-state-mutations]].
