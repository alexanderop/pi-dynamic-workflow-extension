...
We will record architectural decisions in `brain/decisions/adr/`.
...
Keep reverse-engineered feature facts in `spec.md`. Keep implementation planning in `brain/plans/index.md`. Keep final decisions in ADRs.
