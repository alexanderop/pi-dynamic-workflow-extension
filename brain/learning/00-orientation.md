...
| Implementation plan | [`brain/plans/index.md`](../plans/index.md) | How we plan to build it in small tested slices. |
| Architecture decisions | [`brain/decisions/adr/`](../decisions/adr) | Pi-specific choices that future developers should not rediscover. |
...
When you split future work, update `brain/plans/index.md`.
