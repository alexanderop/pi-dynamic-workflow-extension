...
| [`brain/plans/index.md`](../plans/index.md) | Implementation plan and slice status. |
| [`brain/references/error-handling.md`](../references/error-handling.md) | Local Result pattern and error conventions. |
| [`brain/references/testing-reference.md`](../references/testing-reference.md) | Testing strategy copied from Pi patterns. |
| [`brain/references/pi-extension-reference.md`](../references/pi-extension-reference.md) | Local map of relevant Pi extension/package behavior. |
| [`brain/decisions/adr/README.md`](../decisions/adr/README.md) | ADR format and when to record decisions. |

## Current ADRs

- [`brain/decisions/adr/0001-use-adrs-for-workflow-architecture.md`](../decisions/adr/0001-use-adrs-for-workflow-architecture.md)
- [`brain/decisions/adr/0002-use-acorn-and-node-vm-for-first-workflow-runtime.md`](../decisions/adr/0002-use-acorn-and-node-vm-for-first-workflow-runtime.md)
- [`brain/decisions/adr/0003-use-explicit-workflow-state-machines.md`](../decisions/adr/0003-use-explicit-workflow-state-machines.md)
- [`brain/decisions/adr/0004-use-pi-extension-context-for-mode-and-prompt-aware-workflows.md`](../decisions/adr/0004-use-pi-extension-context-for-mode-and-prompt-aware-workflows.md)
- [`brain/decisions/adr/0005-use-project-local-pi-workflow-run-storage.md`](../decisions/adr/0005-use-project-local-pi-workflow-run-storage.md)
- [`brain/decisions/adr/0006-use-terminal-notification-hook-before-pi-message-wiring.md`](../decisions/adr/0006-use-terminal-notification-hook-before-pi-message-wiring.md)
- [`brain/decisions/adr/0007-organize-workflows-as-domain-modules.md`](../decisions/adr/0007-organize-workflows-as-domain-modules.md)
...
```text
brain/references/pi-extension-reference.md
```
