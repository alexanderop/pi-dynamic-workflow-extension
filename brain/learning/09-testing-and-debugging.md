...
The source-of-truth for the test strategy is [`brain/references/testing-reference.md`](../references/testing-reference.md). This guide is the practical, file-by-file debugging companion to it.
...
- New implementation decision: add/update an ADR under [`brain/decisions/adr/`](../decisions/adr).
- New planned slice or status: update [`brain/plans/index.md`](../plans/index.md).
- New onboarding explanation: update a doc under [`./`](./) (this `brain/learning/` folder).
