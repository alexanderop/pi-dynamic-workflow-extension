...
- The `docs/spec-coverage.md` §15 row MUST be updated alongside (see T-C1).

RULE 12.8 (spec location convention): This spec lives at `docs/saved-workflow-scopes-spec.md`, matching the house `docs/<topic>-spec.md` convention — NOT `specs/pending/`, which does not exist in this repo.
