...
[ADR 0004](../adr/0004-use-pi-extension-context-for-mode-and-prompt-aware-workflows.md).
...
plan (README "`/workflows` UI Plan", [ADR 0004](../adr/0004-use-pi-extension-context-for-mode-and-prompt-aware-workflows.md))
