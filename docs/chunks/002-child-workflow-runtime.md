...
- Read `docs/adr/0002-use-acorn-and-node-vm-for-first-workflow-runtime.md`.
- Read `docs/adr/0007-organize-workflows-as-domain-modules.md`.
- Read `docs/adr/0008-use-v2-stable-agent-keys-and-jsonl-journals.md`.
- Read `docs/adr/0009-use-pi-saved-workflow-script-locations.md`.
...
- Keep saved workflow resolution behavior aligned with `docs/spec-coverage.md` row §15 and ADR 0009.
