...
- Read `docs/adr/0001-use-adrs-for-workflow-architecture.md`.
...
- Add a new ADR under `docs/adr/` for the structured-output retry/nudge policy.
- Update `docs/adr/README.md` only if that index is the current ADR convention.
