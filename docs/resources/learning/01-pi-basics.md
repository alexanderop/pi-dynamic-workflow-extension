...
- [`../pi-extension-reference.md`](../../areas/references/pi-extension-reference.md)
...
Keeping runs under the project root scopes workflow state to the project being worked on. The storage decision is recorded in [`../adr/0005-use-project-local-pi-workflow-run-storage.md`](../../areas/adr/0005-use-project-local-pi-workflow-run-storage.md).
