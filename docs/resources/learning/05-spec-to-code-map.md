...
The parser uses Acorn to walk the AST ([ADR 0002](../../areas/adr/0002-use-acorn-and-node-vm-for-first-workflow-runtime.md)).
...
Accepted Pi mapping is documented in [ADR 0005](../../areas/adr/0005-use-project-local-pi-workflow-run-storage.md).
...
Known limitation: Node VM is not treated as a complete security boundary. See [ADR 0002](../../areas/adr/0002-use-acorn-and-node-vm-for-first-workflow-runtime.md).

### §21 Acceptance Criteria

Many criteria are partially satisfied in fake-agent form. Use [`../backlog.md`](../../archive/backlog.md) for the slice-by-slice status.
