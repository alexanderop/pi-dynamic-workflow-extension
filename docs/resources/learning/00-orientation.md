...
| Implementation plan | [`../backlog.md`](../../archive/backlog.md) | How we plan to build it in small tested slices. |
| Architecture decisions | [`../adr/`](../../areas/adr) | Pi-specific choices that future developers should not rediscover. |
...
When you split future work, update `docs/archive/backlog.md`.
...
README.md
spec.md
docs/archive/backlog.md
docs/areas/adr/
docs/resources/learning/
```
