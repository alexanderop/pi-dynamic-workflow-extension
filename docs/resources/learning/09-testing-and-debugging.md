...
The source-of-truth for the test strategy is [`../testing-reference.md`](../../areas/references/testing-reference.md). This guide is the practical, file-by-file debugging companion to it.
...
- New implementation decision: add/update an ADR under [`../adr/`](../../areas/adr).
- New planned slice or status: update [`../backlog.md`](../../archive/backlog.md).
- New onboarding explanation: update a doc under [`./`](./) (this `docs/resources/learning/` folder).
