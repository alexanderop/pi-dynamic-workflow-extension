...
We will record architectural decisions in `docs/areas/adr/`.
...
Keep reverse-engineered feature facts in `spec.md`. Keep implementation planning in `docs/archive/backlog.md`. Keep final decisions in ADRs.
