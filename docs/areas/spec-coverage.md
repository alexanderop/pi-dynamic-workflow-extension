...
- For Pi adapter behavior, also read `docs/areas/references/pi-extension-reference.md` and the
...
- For durable design choices, add or update an ADR under `docs/areas/adr/`.
