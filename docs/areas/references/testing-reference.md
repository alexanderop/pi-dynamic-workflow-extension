...
Companion planning spec: `docs/projects/test-page-objects/spec.md` describes the future testing DSL, domain builders, `/workflows` screen object, and workflow scenario harness we intend to use when refactoring noisy tests.
...
captured in `docs/projects/agent-mock-boundary/spec.md`.
